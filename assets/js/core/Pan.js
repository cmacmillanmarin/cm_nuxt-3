...
export default class Pan {
    constructor(opts) {
        ...
        this.isTouchableScreen = opts.isTouchableScreen;
        this.prevent = this.defined(opts.prevent, false);
        ...
        this.eventPassive = false; // HARDCODED because we are using SMOOTH SCROLL
    ...
    addListeners() {
        this.target.addEventListener("touchstart", this.onTouchStartHandler, {passive: this.eventPassive});
        this.target.addEventListener("mousedown", this.onTouchStartHandler);
        this.isTouchableScreen && this.addDragListeners();
    }
    ...
    removeListeners() {
        ...
        this.isTouchableScreen && this.removeDragListeners();
    }

    addDragListeners() {
        document.addEventListener("touchmove", this.onTouchMovementHandler, {passive: this.eventPassive});
    ...
    removeDragListeners() {
        document.removeEventListener("touchmove", this.onTouchMovementHandler, {passive: this.eventPassive});
    ...
    handleTouchEnd(e) {
        ...
        this.onPanEnd({id: this.id, x: this.x, y: this.y, xDiff: this.xDiff, yDiff: this.yDiff, xDir: this.xDir, yDir: this.yDir, xVel: this.xVel, yVel: this.yVel, time});
